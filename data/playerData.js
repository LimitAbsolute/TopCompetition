...
const playerData = [{
    ...
    },
    {
        ...
        data: [{
            ...
            },
            {
                ...
                P.S. 最后一局比赛前，赛委会对灰烬进行了评估，已经到达了退赛的标准，不过灰烬在场下遇到了来现场看比赛的黑金刚团队，在其指导帮助下，进行了简单的包扎与装甲粘合后，勉强达到了继续参赛的标准，赛委会于是予以批准继续比赛。`
            },
        ],
        "description": ""
    },
    ...
    },
    {
        ...
        "description": "第二届扩增三种量级，分级对抗；新引入双败赛制(决赛BO3)；使用新竞技台"
    },
    {
        no: 12,
        weight: 3,
